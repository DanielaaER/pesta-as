                  ...
                  return ListTile(
                    title: TextButton(
                      onPressed: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => ViewPage(urlAbiertas[index], pestanasAbiertas[index]),));
                      },
                      child: Text(pestanasAbiertas[index]),
                    ),
                    trailing: IconButton(
                      icon: Icon(Icons.close),
                      onPressed: () => eliminarPestana(pestanasAbiertas[index], urlAbiertas[index]),
                    ),
                  );
                },
